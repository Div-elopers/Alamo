...
class _AppleSignInScreenState extends ConsumerState<AppleSignInScreen> {
  Future<void> _signInWithApple() async {
   ...
   Widget build(BuildContext context) {
    ...
    return Center(
      child: PrimaryButton(
        isLoading: state.isLoading, // El botón muestra un spinner si está en estado de carga
        onPressed: state.isLoading ? null : _signInWithApple, // Deshabilita el botón si está cargando
        child: Row(
